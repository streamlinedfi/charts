...
const renderRSI = ({
  ...
  const kPoints = series
    .map(entry => [scales.x(entry.i), yScale(entry.values.k)])
    .filter(
      ([x, y]) =>
        y !== undefined &&
  ...
  const dPoints = series
    .map(entry => [scales.x(entry.i), yScale(entry.values.d)])
    .filter(
      ([x, y]) =>
        y !== undefined &&
        inRange(x, indicatorFrame.xStart, indicatorFrame.xEnd),
  ...
  return [
    ...
    },
    {
      ...
      attrs: {
        ...
        fill: config.theme.indicators.stochastic.bgColor,
      },
    },
    {
      type: 'Line',
      attrs: {
        stroke: config.theme.indicators.stochastic.upperLineColor,
        strokeWidth: 1,
        dash: [3, 4],
        points: [
          indicatorFrame.xStart,
    ...
    },
    {
      type: 'Line',
      attrs: {
        stroke: config.theme.indicators.stochastic.middleLineColor,
        strokeWidth: 1,
        dash: [3, 4],
        points: [
          indicatorFrame.xStart,
    ...
    },
    {
      type: 'Line',
      attrs: {
        stroke: config.theme.indicators.stochastic.lowerLineColor,
        strokeWidth: 1,
        dash: [3, 4],
        points: [
          indicatorFrame.xStart,
